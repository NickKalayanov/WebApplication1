...
using WebApplication1_Utility.BrainTree;
...
namespace WebApplication1.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public CartController(ApplicationDbContext db, IWebHostEnvironment webHostEnvironment, IEmailSender emailSender, IInquiryHeaderRepository inqHRepo, IInquiryDetailRepository inqDRepo, IProductRepository prodRepo, IApplicationUserRepository userRepo, IOrderHeaderRepository orderHRepo, IOrderDetailRepository orderDRepo, IBrainTreeGate brain)
        {
        ...
        public async Task<IActionResult> SummaryPost(IFormCollection collection, ProductUserVM ProductUserVM)
        {
            ...
            if (User.IsInRole(WC.AdminRole))
            {
                ...
                _orderHRepo.Save();
                return RedirectToAction(nameof(IquiryConfirmation), new { id = orderHeader.Id });
            }
            else
            {
                var PathToTemplate = _webHostEnvironment.WebRootPath + Path.DirectorySeparatorChar.ToString() + "templates" + Path.DirectorySeparatorChar.ToString() + "Inquiry.html.html";
                var subject = "New Inquity";
                string HtmlBody = "";
                ...
                string messageBody = string.Format(HtmlBody, ProductUserVM.ApplicationUser.FullName, ProductUserVM.ApplicationUser.Email, ProductUserVM.ApplicationUser.PhoneNumber, productListSB.ToString());
            ...
            return RedirectToAction(nameof(IquiryConfirmation));
        }
        public IActionResult IquiryConfirmation(int id=0)
        {
